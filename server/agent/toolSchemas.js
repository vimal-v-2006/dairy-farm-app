...
const toolSchemas = {
  ...
  getCowsList: z.object({ status: z.string().optional() }),
...
const toolDefinitions = [
  ...
  { name: 'getCowsList', description: 'Fetch list of all cows, optionally filtered by status.', parameters: { status: 'optional status like Lactating, Dry, Sold, Deceased' } },
